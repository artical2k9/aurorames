...
| ERR-MES-081 | 2026-06-10 | Deployment — Docker / Security | Stale gateway container ran pre-`permitAll` config → 401 on newly-public endpoint; rebuild the image after any gateway/service security-config commit, don't trust a running container |
