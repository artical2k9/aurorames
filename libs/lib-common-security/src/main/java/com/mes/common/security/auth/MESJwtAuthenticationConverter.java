...
public class MESJwtAuthenticationConverter implements Converter<Jwt, JwtAuthenticationToken> {

    private final PrivilegeCache privilegeCache;

    public MESJwtAuthenticationConverter(PrivilegeCache privilegeCache) {
