package com.mes.engineering.eco.service;

import com.mes.engineering.eco.api.dto.CreateEcoRequest;
import com.mes.engineering.eco.api.dto.EcoDto;
import com.mes.engineering.eco.api.dto.EcoMapper;
import com.mes.engineering.eco.domain.EcoStatus;
import com.mes.engineering.eco.domain.EngineeringChangeOrder;
import com.mes.engineering.eco.repository.EcoRepository;
import com.mes.engineering.kafka.EcoEventPublisher;
...
public class EcoService {
    ...
    public void addOutputBom(UUID ecoId, UUID bomId) {
        EngineeringChangeOrder eco = ecoRepository.findById(ecoId)
                .orElseThrow(() -> new EcoNotFoundException("ECO not found: " + ecoId));
        if (!eco.getOutputBomIds().contains(bomId)) {
