package com.mikemes.platform.integration.api;
...
class SystemConfigControllerIT {
    ...
    static void props(DynamicPropertyRegistry registry) {
        ...
        registry.add("mikemes.security.webhook-token", () -> WEBHOOK_TOKEN);
        registry.add("mikemes.security.iam-service-url", () -> "http://localhost:8085");
    }
