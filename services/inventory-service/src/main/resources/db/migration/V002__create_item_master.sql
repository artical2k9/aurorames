...
CREATE INDEX idx_item_master_org_part_rev ON inventory.item_master (org_id, part_number, revision);
CREATE INDEX idx_item_master_org_status   ON inventory.item_master (org_id, status);
CREATE INDEX idx_item_master_org_class    ON inventory.item_master (org_id, classification);
