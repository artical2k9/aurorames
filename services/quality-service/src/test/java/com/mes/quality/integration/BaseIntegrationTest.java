package com.mes.quality.integration;
...
@EmbeddedKafka(partitions = 1,
        topics = {"iam.privilege-changes", "quality.inspection-plan.approved"},
...
public abstract class BaseIntegrationTest {
    ...
    // WireMock stubs inventory-service item-existence/denorm calls (no inventory container in IT stack).
    protected static final WireMockServer INVENTORY_WIREMOCK =
        ...
        PrivilegeCache testPrivilegeCache() {
            return role -> switch (role) {
                case "SYSTEM_ADMIN" -> Set.of(
                        "quality:inspection-plan:create", "quality:inspection-plan:read",
                        "quality:inspection-plan:update", "quality:inspection-plan:delete",
                        "quality:inspection-plan:approve");
                case "ENGINEER" -> Set.of("quality:inspection-plan:read");
                default -> Set.of();
            };
        }
    }
    ...
    static void props(DynamicPropertyRegistry registry) {
        ...
        registry.add("mes.quality.inventory-service-url", INVENTORY_WIREMOCK::baseUrl);
