...
@Table(name = "engineering_change_order", schema = "work_order")
public class EngineeringChangeOrder {
    ...
    @CollectionTable(name = "eco_affected_item", schema = "work_order",
    ...
    @NotAudited
    @ElementCollection(fetch = FetchType.EAGER)
    @CollectionTable(name = "eco_output_bom", schema = "work_order",
            joinColumns = @JoinColumn(name = "eco_id"))
    @Column(name = "bom_id")
